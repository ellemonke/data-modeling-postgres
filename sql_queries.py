...
CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time timestamp, user_id int, \
...
song_select = ("""
SELECT songs.title FROM songplays JOIN songs ON songplays.song_id=songs.song_id
""")
